...
class Cart(object):
    ...
    ## Get the coupon_id session key from the current session
    @property
    def coupon(self):
        # Define this method as a property. If the cart contains 
    ...
    def get_discount(self):
        # If the cart contains a coupon, you retrieve its discount 
